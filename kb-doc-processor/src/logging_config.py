...
def setup_logging(level: int = logging.INFO):
    ...
    try:
        ...
        log_dir = os.environ.get("DOC_PROCESSOR_LOG_DIR", "logs")
        os.makedirs(log_dir, exist_ok=True)
        json_file = os.path.join(log_dir, "doc-processor.json")
        ...
        # If python-json-logger is not installed or file creation fails,
        # silently skip — console logging still works
        pass
