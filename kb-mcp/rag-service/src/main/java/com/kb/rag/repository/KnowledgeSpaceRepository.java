...
public interface KnowledgeSpaceRepository extends JpaRepository<KnowledgeSpace, String> {
    ...
    List<KnowledgeSpace> findSubtreeByTenantIdAndNodePath(@Param("tenantId") String tenantId,
    ...
    List<String> findSubtreeIdsByTenantIdAndNodePath(@Param("tenantId") String tenantId,
                                                      @Param("nodePath") String nodePath);
}
